...
const services = [
  ...
  },
  {
    ...
    desc: "Texas offers a rich landscape of public finance tools that can meaningfully improve project economics. Watershed has direct experience structuring projects using TIRZ, PIDs, MUDs, LIHTC, Historic Tax Credits, and Opportunity Zone designations — reducing equity requirements and improving investor returns.",
    bullets: [
