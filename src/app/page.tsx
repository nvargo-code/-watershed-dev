    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center bg-[#0b1220] overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-1 bg-[#e87722]" />
          <div className="absolute top-1/2 right-[10%] w-px h-48 bg-[#e87722]/30" />
          <div className="absolute top-1/4 right-[30%] w-2 h-2 rounded-full bg-[#e87722]/40" />
        </div>

        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 pt-32 pb-24">
          <div className="max-w-4xl">
            <p className="text-[#e87722] text-xs font-semibold tracking-[0.3em] uppercase mb-6">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-8xl font-black text-white leading-[0.95] mb-8 uppercase tracking-tight">
              We Live for<br />
              <span className="text-[#e87722]">Groundbreaking</span><br />
              Moments
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/services"
                className="inline-flex items-center gap-3 px-8 py-4 bg-[#e87722] hover:bg-[#d0681a] text-white font-semibold uppercase tracking-wide text-sm transition-colors duration-200"
              >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            <div>
              <p className="text-[#e87722] text-xs font-semibold tracking-[0.3em] uppercase mb-3">What We Do</p>
              <h2 className="text-4xl lg:text-5xl font-black text-[#0b1220] uppercase leading-tight">
                Full-Lifecycle<br />Development Consulting
              </h2>
            </div>
            <Link href="/services" className="inline-flex items-center gap-2 text-[#e87722] font-semibold text-sm uppercase tracking-wide hover:gap-3 transition-all">
      ...
      <section className="py-24 bg-[#f5f5f5]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-[#e87722] text-xs font-semibold tracking-[0.3em] uppercase mb-4">Our Mission</p>
            ...
            <Link href="/about" className="inline-flex items-center gap-2 text-[#e87722] font-semibold text-sm uppercase tracking-wide hover:gap-3 transition-all">
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              <div key={item.title} className="bg-white p-6 border-t-2 border-[#e87722]">
                <item.icon size={24} className="text-[#e87722] mb-3" />
      ...
      <section className="py-24 bg-[#0b1220]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            <div>
              <p className="text-[#e87722] text-xs font-semibold tracking-[0.3em] uppercase mb-3">Track Record</p>
              <h2 className="text-4xl lg:text-5xl font-black text-white uppercase leading-tight">
                Featured Projects
              </h2>
            </div>
            <Link href="/projects" className="inline-flex items-center gap-2 text-[#e87722] font-semibold text-sm uppercase tracking-wide hover:gap-3 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10">
            {[
              ...
              <div key={p.name} className="bg-[#162035] p-8 group hover:bg-[#e87722] transition-colors duration-300 cursor-pointer">
                <p className="text-[#e87722] group-hover:text-white/80 text-xs uppercase tracking-widest mb-4 transition-colors">{p.tag}</p>
          ...
          <div className="mt-10 text-center">
            <Link href="/projects" className="inline-flex items-center gap-3 px-8 py-4 border border-white/20 hover:border-[#e87722] text-white hover:text-[#e87722] font-semibold uppercase tracking-wide text-sm transition-colors duration-200">
      ...
      {posts.length > 0 && (
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
              <div>
                <p className="text-[#e87722] text-xs font-semibold tracking-[0.3em] uppercase mb-3">Market Intelligence</p>
                <h2 className="text-4xl lg:text-5xl font-black text-[#0b1220] uppercase leading-tight">
                  Development Insights
                </h2>
              </div>
              <Link href="/blog" className="inline-flex items-center gap-2 text-[#e87722] font-semibold text-sm uppercase tracking-wide hover:gap-3 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {posts.map((post) => (
                <Link key={post.slug} href={`/blog/${post.slug}`} className="group block">
                  <div className="bg-[#f5f5f5] p-8 h-full group-hover:bg-[#0b1220] transition-colors duration-300">
                    <p className="text-[#e87722] text-xs font-semibold uppercase tracking-widest mb-3">{post.category}</p>
                    ...
                    <div className="mt-6 flex items-center gap-2 text-[#e87722] text-xs font-semibold uppercase tracking-wide">
